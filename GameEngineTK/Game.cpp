...
void Game::Initialize(HWND window, int width, int height)	// èâä˙âª
{
    m_window = window;
...
// Updates the world.
void Game::Update(DX::StepTimer const& timer)	// çXêV
{
    float elapsedTime = float(timer.GetElapsedSeconds());

    // TODO: Add your game logic here.
    elapsedTime;
	// ÉQÅ[ÉÄÇÃñàÉtÉåÅ[ÉÄèàóù
}

// Draws the scene.
void Game::Render()	// ï`âÊ
{
	...
	primitiveBatch->DrawTriangle(VertexPositionColor(Vector3(200.0f,200.0f,0.0f),Colors::Red), 
		VertexPositionColor(Vector3(100.0f,350.0f,0.0f),Colors::White),
		VertexPositionColor(Vector3(300.0f,350.0f,0.0f),Colors::White));
	primitiveBatch->End();
